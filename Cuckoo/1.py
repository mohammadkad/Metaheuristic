...
def cuckoo_search(func, dim, n, pa, lb, ub, max_iter):
    """
    ...
    for _ in range(max_iter):
        ...
        new_nests = np.array([levy_flight(x, dim, lb, ub) for x in nests])
...
best_x, best_f = cuckoo_search(objective_function, dim, n, pa, lb, ub, max_iter)
